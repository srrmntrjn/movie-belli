...
import { ThumbsDown, Meh, ThumbsUp, Loader2 } from "lucide-react";
import {
  InitialRankingList,
  type RankingMovie,
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-h-[90vh] overflow-y-auto max-w-[95vw] sm:max-w-2xl">
        <DialogHeader>
          <DialogTitle>
            {phase === "rate" && "How would you rate this movie?"}
            {phase === "initial" && "Rank your initial movies"}
            {phase === "compare" && "Where does this fit?"}
          </DialogTitle>
        </DialogHeader>
